...
namespace SportsStore.Tests
{
    public class CartTests
    {
        ...
        {
            //Arrange - creation of test products
            Product p1 = new Product { ProductID = 1, Name = "P1" };
            Product p2 = new Product { ProductID = 2, Name = "P2" };

            //Arrange - creation of new Cart object
        ...
        {
            //Arrange - creation of new test products
            Product p1 = new Product { ProductID = 1, Name = "P1" };
            Product p2 = new Product { ProductID = 2, Name = "P2" };
        ...
        public void Can_Clear_Contents()
        {
            ...
            //Arrange - adding a few products to cart
            target.AddItem(p1, 1);
            target.AddItem(p2, 1);

            //Act - clearing the cart
            target.Clear();
